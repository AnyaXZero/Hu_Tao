...
async def awake(_, message: Message):
    ...
    if message.from_user.id == OWNER_ID:
        TEXT = "ɪ'ᴍ ᴀʟɪᴠᴇ ᴍʏ ʟᴏʀᴅ <a href='https://files.catbox.moe/trb0eb.jpg' target='_blank'>⚡</a> !\n\n"
    else:
        TEXT = f"ʏᴏᴏ {message.from_user.mention}, <a href='https://files.catbox.moe/t9p1dw.jpg' target='_blank'>⚡</a>\n\nɪ'ᴍ {app.mention}\n──────────────────\n"
